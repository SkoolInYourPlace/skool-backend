...
public class EarthSearch {
	...
	private static final String API_KEY = "AIzaSyBVw02Wj-xEf54pWKPahY37B5tx_xZww-Y";
...
//>>>>>>> branch 'master' of https://github.com/Celethor/CS360proj1.git
	...
	*/
	...
	public static void main(String args[]) throws ApiException, InterruptedException, IOException{
		...
		String[] origins = {"13.1298989","77.6169845"};
		String[] destinations = {"12.9048418","77.6458814"};
		GeoApiContext context = new GeoApiContext.Builder()
			    .apiKey(API_KEY)
			    .build();
